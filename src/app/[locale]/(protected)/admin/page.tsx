...
import { CpuChipIcon, Cog6ToothIcon, Squares2X2Icon, PresentationChartLineIcon, CheckBadgeIcon, TagIcon, UsersIcon, ScaleIcon, WrenchScrewdriverIcon } from '@heroicons/react/24/outline';
...
export default function AdminOverview() {
    ...
    const cards = [
        ...
        { href: '/admin/conditions', icon: CheckBadgeIcon, title: dict.admin.conditions, text: dict.admin.cardConditions },
